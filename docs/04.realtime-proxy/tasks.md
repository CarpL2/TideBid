...
- [ ] 使用两个浏览器用户演示代理反击、反狙击延时、断线恢复和最终订单。（2026-09-25：`smoke.ps1 -RealtimeProxyDemo` 已补齐 B 提高代理、A/B 同 eventId、MySQL 历史一致和断线 Snapshot；当前仍待真实浏览器页面、AUCTION_CLOSED 和订单入口。）
