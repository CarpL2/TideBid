 ...
 * Source: https://github.com/alibaba/nacos/blob/3.0.3/distribution/conf/mysql-schema.sql
...
CREATE TABLE `config_tags_relation` (
    ...
    `group_id` varchar(128) NOT NULL COMMENT 'group_id',
    `tenant_id` varchar(128) DEFAULT '' COMMENT 'tenant_id',
    `nid` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'auto increment id',
    PRIMARY KEY (`nid`),
...
CREATE TABLE `group_capacity` (
    ...
    `max_size` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'max config size',
    `max_aggr_count` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'max aggregate count',
    `max_aggr_size` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'max aggregate size',
...
CREATE TABLE `his_config_info` (
    ...
    `nid` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'auto increment id',
    `data_id` varchar(255) NOT NULL COMMENT 'data_id',
    `group_id` varchar(128) NOT NULL COMMENT 'group_id',
    `app_name` varchar(128) DEFAULT NULL COMMENT 'app_name',
    `content` longtext NOT NULL COMMENT 'content',
    ...
    `ext_info` longtext DEFAULT NULL COMMENT 'extended info',
    PRIMARY KEY (`nid`),
    KEY `idx_gmt_create` (`gmt_create`),
    KEY `idx_gmt_modified` (`gmt_modified`),
    KEY `idx_did` (`data_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='configuration history';
