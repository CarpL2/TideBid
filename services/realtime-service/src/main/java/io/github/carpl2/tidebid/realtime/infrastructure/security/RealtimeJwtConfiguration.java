...
public class RealtimeJwtConfiguration {
    ...
    RSAPublicKey realtimeJwtPublicKey(
    ...
    JwtAccessTokenVerifier realtimeJwtAccessTokenVerifier(RSAPublicKey publicKey, Clock clock) {
