...
public class RealtimeSecurityConfiguration {
    ...
    SecurityFilterChain realtimeAuthenticatedSecurityFilterChain(
            HttpSecurity http,
        ...
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/api/realtime/tickets").authenticated()
                        .anyRequest().permitAll())
                .addFilterBefore(new RealtimeBearerTokenFilter(tokenVerifier, authenticationEntryPoint),
                        UsernamePasswordAuthenticationFilter.class);
        return http.build();
    }

    private static void writeFailure(HttpServletRequest request, HttpServletResponse response,
                                     ObjectMapper objectMapper, CommonErrorCode errorCode) throws IOException {
