...
public record AccountRocketMqProperties(
    ...
    public AccountRocketMqProperties {
    ...
    public record ConsumerGroups(
            @DefaultValue(RocketMqTopology.ACCOUNT_DEPOSIT_CONSUMER_GROUP) String depositSettlement,
            @DefaultValue(RocketMqTopology.ACCOUNT_CREDIT_CONSUMER_GROUP) String sellerCredit
    ) {
        public ConsumerGroups {
            requireExact(depositSettlement, RocketMqTopology.ACCOUNT_DEPOSIT_CONSUMER_GROUP,
                    "consumerGroups.depositSettlement");
            requireExact(sellerCredit, RocketMqTopology.ACCOUNT_CREDIT_CONSUMER_GROUP,
                    "consumerGroups.sellerCredit");
        }
    }
